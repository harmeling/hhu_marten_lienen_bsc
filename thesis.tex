...
Affine transformations are not terribly interesting, because they can be
calculated calculated exactly through parameter transformations. We will plot
one anyway to demonstrate, that the attached library can correctly compute
it. In figure \ref{fig:affine} we apply the affine transformation
\begin{equation*}
