...
Consider $X \in \mathbb{R}^{n}$ a continuous random vector,
$f : \supp(X) \rightarrow \mathbb{R}$ a function defined on at least the support
of $X$ and $Y = f(X)$. The task is then to derive the probability distribution
of $Y$ from the known distribution of $X$.
